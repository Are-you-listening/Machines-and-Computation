...
public:
    ...
    void inputData() {
        addRule("C -> KD");
        addRule("S -> NN | TB | c | d | e | f | i | v | a | EC | ED");
        addRule("B -> TB | c | d | e | f | i | v | a");
        addRule("T -> c | d | e | f | i | v | a");
        addRule("N -> NN | TB | c | d | e | f | i | v | a | EH | ED");
        addRule("K -> KK | TB | c | d | e | f | i | v | a | EF | ED");
        addRule("A -> AA | TB | c | d | e | f | i | v | a | EG | ED");
        addRule("F -> AD");
        addRule("G -> KD");
        addRule("E -> {");
        addRule("D -> }");
